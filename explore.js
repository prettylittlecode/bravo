    ...
    products.forEach(product => {
      ...
      productElement.innerHTML = `
        ...
        <a <button="" href="${product.url} type=" button"="" style="height: 45px;padding: 0px;text-decoration: none;color: white;text-align: center;display: flex;">
           <img alt="Image description" style="height: 30px;margin-top: 17px;padding-right: 5px;" src="https://i.postimg.cc/fbgg9FHp/ariaplus-blue-square-full-back1.jpg"> <p class="like-number" style="padding: 0px;margin: 0px;width: 30px;display: flex;margin-left: ;margin-top: 25px;"> X</p></a>
